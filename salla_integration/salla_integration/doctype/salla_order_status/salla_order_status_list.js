...
frappe.listview_settings['Salla Order Status'] = {
    onload: function(listview) {
        ...
        listview.page.add_inner_button(__('Import All from Salla'), function() {
            frappe.confirm(
                __('This will import all Order Statuses from Salla. New Items will be created for Salla Order Statuses, and existing Order Statuses will be Updates. Continue?'),
                () => {
                    frappe.call({
