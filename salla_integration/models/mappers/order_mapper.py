...
class OrderMapper:
	...
	@staticmethod
	def salla_to_erpnext(salla_order: dict[str, Any], customer_name: str, company: str) -> dict[str, Any]:
		"""
	...
	@staticmethod
	def _find_item_code(salla_item: dict) -> str | None:
		"""
		...
		if product_id:
			item_code = frappe.db.get_value(
				"Salla Product", {"salla_product_id": str(product_id)}, "item_code"
			)
			if item_code:
				return item_code
	...
	@staticmethod
	def map_shipping_address(salla_order: dict[str, Any], customer_name: str) -> dict[str, Any] | None:
		"""
