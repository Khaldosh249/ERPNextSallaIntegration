...
class TestProductSchema(unittest.TestCase):
	...
	def test_validate_for_salla_valid(self):
		...
		data = {"name": "Test Product", "price": 100, "quantity": 50}
	...
	def test_validate_for_salla_negative_quantity(self):
		...
		data = {"name": "Test", "price": 50, "quantity": -10}
...
class TestCustomerSchema(unittest.TestCase):
	...
	def test_valid_email(self):
		...
		data = {"customer_name": "Test Customer", "email": "test@example.com"}
	...
	def test_invalid_email(self):
		...
		data = {"customer_name": "Test Customer", "_email": "invalid-email"}
