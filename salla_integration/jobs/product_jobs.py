...
def sync_stock_to_salla_job(item_code: str, warehouse: Optional[str] = None) -> Dict[str, Any]:
    """
...
def enqueue_bulk_product_sync(filters: Optional[Dict] = None):
