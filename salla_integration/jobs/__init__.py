...
from salla_integration.jobs.customer_jobs import import_customers_from_salla_job
from salla_integration.jobs.order_jobs import import_orders_from_salla_job
