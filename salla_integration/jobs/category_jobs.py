...
def sync_all_categories_job() -> dict[str, Any]:
	...
	categories = frappe.get_all(
		"Salla Category", filters={"sync_to_salla": 1}, fields=["name"], order_by="lft asc"
	)
	...
	return {"status": "success", "success": success, "failed": failed, "total": len(categories)}
...
def import_categories_from_salla_job() -> dict[str, Any]:
	...
	return {"status": "success", "imported": imported, "failed": failed, "total": len(categories)}
