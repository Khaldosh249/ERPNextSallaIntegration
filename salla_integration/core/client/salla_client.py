...
class SallaClient:
    ...
    def _make_request(
        ...
        try:
            ...
            raise SallaTimeoutError(
                message=f"Request to {endpoint} timed out after {timeout} seconds"
            )
        except requests.ConnectionError as e:
            raise SallaConnectionError(
                message=f"Failed to connect to Salla API: {str(e)}"
            )
    ...
    def update_product(self, product_id: str, payload: Dict, lang: str = "ar") -> Dict:
        ...
        response = self._make_request("PUT", f"products/{product_id}", data=payload, custom_headers=lang_header)
        return response.json()
    ...
    def get_products(self, lang: str = "ar", params: Optional[Dict] = None) -> Dict:
        """
    ...
    def upload_product_image(self, product_id: str, image_path: str, form_data = {}) -> Dict:
        """
    ...
    def update_category(self, category_id: str, payload: Dict, lang: str = "ar") -> Dict:
        ...
        """
        lang_header = {"ACCEPT-LANGUAGE": lang}
        response = self._make_request("PUT", f"categories/{category_id}", data=payload, custom_headers=lang_header)
        return response.json()
    ...
    def get_categories(self, params: Optional[Dict] = None, lang: str = "ar") -> Dict:
        """
    ...
    def get_orders(self, params: Optional[Dict] = None) -> Dict:
        """
    ...
    def get_order_statuses(self, params: Optional[Dict] = None) -> Dict:
        """
