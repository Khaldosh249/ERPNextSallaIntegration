...
class SallaValidationError(SallaAPIError):
    ...
    def __init__(self, message: str = "Validation error", errors: dict = None, **kwargs):
...
class SallaNotFoundError(SallaAPIError):
    ...
    def __init__(self, message: str = "Resource not found", resource_type: str = None, resource_id: str = None, **kwargs):
